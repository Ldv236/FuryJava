package ru.lessons24.OOP.EqualsHashCode;
...
//        Car car2 = new Car("Tesla Model S", 2022, 4);
        ...
        System.out.println("Equals: " + car1.equals(car2)); // false
        System.out.println("HashCode car1: " + car1.hashCode());
        System.out.println("HashCode car2: " + car2.hashCode());
        System.out.println("Car1 == car2 by hashCode: " + (car1.hashCode() == car2.hashCode()));
    }
}
